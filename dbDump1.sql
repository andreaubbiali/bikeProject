...
CREATE TABLE `subscription` (
  ...
  PRIMARY KEY (`id`),
  KEY `subscription_FK` (`user_id`),
  KEY `subscription_FK_1` (`type_id`),
  CONSTRAINT `subscription_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `subscription_FK_1` FOREIGN KEY (`type_id`) REFERENCES `subscription_type` (`id`)
...
-- Dump completed on 2021-07-26 17:50:46
